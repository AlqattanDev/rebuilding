...
export const ASCIIArtHeader: React.FC<ASCIIArtHeaderProps> = ({
  ...
  const sizeClasses = {
    small: 'text-[8pt] leading-[1.1]',
    medium: 'text-[10pt] leading-[1.2]',
    large: 'text-[12pt] leading-[1.3]',
  };

  return (
    <div className="ascii-art-header mb-8">
      <pre className={`ascii-name font-mono font-bold ${sizeClasses[size]} text-terminal-green`}>
